    ...
    <>
      ...
      <div className="tlPage">
        ...
        <section className="tl__section" aria-label="Project Overview">
          <h2 className="tl__sectionTitle">Project Overview</h2>
          <p>Thirsty Lion was a final group (4) project for a UI Design class.</p>
          <p><strong>Skills:</strong> Smoke-and-mirrors prototyping, journey mapping, figma, low and high-fidelity mockups, iterative user testing</p>
          <p><strong>The Problem:</strong> Columbia students often encounter broken, slow, or warm water fountains, leading to frustration and dehydration. Even when familiar with the building, students often struggle to find the next best water fountain and fountains are not listed on building maps.</p>
        ...
        <section className="tl__section" aria-label="Smoke & Mirrors Prototype">
          ...
          <ul className="tl__list">
            <li><strong>The Setup:</strong> Placed QR-coded posters at 8 different fountains.</li>
        ...
        <section className="tl__section" aria-label="Design & Prototyping">
          ...
          <ul className="tl__list">
            ...
            <div className="tl__img" aria-label="Low-fidelity mockup">
              <img src="/images/thirstylion-lowfid.png" alt="High-fidelity mockup 1 of the Thirsty Lion app" />
            </div>
            
            <div className="tl__img" aria-label="High-fidelity mockup">
